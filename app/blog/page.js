...
export default function BlogPage() {
  return (
    ...
    <main className="max-w-4xl mx-auto p-20 bg-white text-gray-800 mt-5">
      ...
      <p className="mb-6">
        ...
        ki search me ho, to yeh blog aapke liye perfect hai. Ham high‑quality heat‑resistant glassware
        banate hain jo lab, home, restaurant aur gifting sabke use ke liye suitable hota hai.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">Borosilicate Glassware – Heat Resistant & Durable</h2>
      <p>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Customized Glassware – Branding, Shapes & Sizes</h2>
      <p>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Why Choose Our Glassware?</h2>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">SEO Keywords</h2>
      <div className="flex flex-wrap gap-2">
        <span className="px-3 py-1 bg-gray-200 rounded-full text-sm">Glassware Manufacturer in Delhi</span>
        <span className="px-3 py-1 bg-gray-200 rounded-full text-sm">Borosilicate Glassware</span>
        <span className="px-3 py-1 bg-gray-200 rounded-full text-sm">Customized Glassware</span>
        <span className="px-3 py-1 bg-gray-200 rounded-full text-sm">Lab Glassware Delhi</span>
      </div>
